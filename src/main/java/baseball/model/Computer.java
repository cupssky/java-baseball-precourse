...
public class Computer {
	...
	/**
	 * 중복값 체크 <br/>
	 * 받아온 랜덤 값이 List에 포함되어 있는지 체크한다.
	 * @param randomNumber 랜덤값
	 * @return boolean
	 */
	...
	/**
	 * 힌트를 생성한다.
	 * @param computerNumberList 컴퓨터 입력값
	 * @param playerNumberList 플레이어 입력값
	 * @return String
	 */
	 ...
	 * @param computerNumber 컴퓨터 입력값
	 * @param playerNumber 플레이어 입력값
	 * @return int
	 */

...
public class GameMessage {
    ...
    public static final String ERROR_MESSAGE_INPUT_NUMBER_LENGTH = "[ERROR] " + BallConfig.INPUT_SIZE + "자리 숫자만 입력 가능합니다. 다시 입력해주세요.";
    public static final String ERROR_MESSAGE_INPUT_NUMBER_SCOPE = "[ERROR] " + BallConfig.MIN_NUMBER + "부터 " + BallConfig.MAX_NUMBER + "까지의 숫자만 입력 가능합니다. 다시 입력해주세요.";
